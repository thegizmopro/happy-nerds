...
export const CHAPTER_1 = [
  ...
  // King hp: 1 (stretch form only has 1 shot, so king must be 1-hittable).
  {
    ...
    defaultParams: { a: -0.10, h: 0, k: 0 },
    launcher: LAUNCHER,
    targets: [{ id: 'king', x: 7.2, y: 0, radius: 0.55, pigType: 'king', hp: 1, moving: null }],
    obstacles: [
      { id: 'wall_front',  x: 4.2, y: 0, width: 0.5, height: 3.5, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort_left',   x: 6.0, y: 0, width: 0.4, height: 2.4, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort_base',   x: 6.4, y: 0, width: 1.2, height: 0.7, blockType: 'concrete', hp: 2, supports: ['fort_ceil'] },
      { id: 'fort_right',  x: 8.2, y: 0, width: 0.4, height: 2.4, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort_ceil',   x: 6.0, y: 2.4, width: 2.6, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
    starThresholds: [1, 2], starMode: 'moves',
