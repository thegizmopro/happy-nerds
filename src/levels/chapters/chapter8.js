...
export const CHAPTER_8 = [
  ...
  // Single standard form equation. Bonus ring at peak.
  {
    ...
    obstacles: [
      ...
      { id: 'fort_ol', x: 6.5,  y: 0.6, width: 0.4,  height: 3.2, blockType: 'concrete', hp: 2, supports: ['fort_roof'] },
      ...
      { id: 'fort_or', x: 8.7,  y: 0.6, width: 0.4,  height: 3.2, blockType: 'concrete', hp: 2, supports: ['fort_roof'] },
  ...
  // Uses mixed equation forms per shot.
  {
    ...
    obstacles: [
      ...
      { id: 'stair_top',x: 4.7, y: 0.6, width: 0.5, height: 1.1, blockType: 'concrete', hp: 2, supports: [] },
      ...
      { id: 'k8_4wl',   x: 7.8, y: 0.6, width: 0.35, height: 2.2, blockType: 'concrete', hp: 2, supports: ['k8_4rf'] },
      { id: 'k8_4wr',   x: 9.2, y: 0.6, width: 0.35, height: 2.2, blockType: 'concrete', hp: 2, supports: ['k8_4rf'] },
  ...
  // moving king pig behind stone fortress. 5 shots, 3 forms, bonus ring.
  {
    ...
    obstacles: [
      ...
      { id: 'cas_wl',   x: 5.5,  y: 0.6, width: 0.35, height: 2.5,  blockType: 'concrete', hp: 2, supports: ['cas_roof'] },
      ...
      { id: 'king_wl',  x: 7.6,  y: 0.6, width: 0.35, height: 3.0,  blockType: 'concrete', hp: 2, supports: ['king_rf'] },
