...
multiShot: {
    ...
    targets: [
      { id: 'pig_l', x: 4.45, y: 1.4, radius: 0.42, pigType: 'helmet', hp: 1, moving: null, restingOn: 'b1_shelf' },
      { id: 'pig_r', x: 8.15, y: 1.4, radius: 0.42, pigType: 'helmet', hp: 1, moving: null, restingOn: 'b1_shelf2' },
    ],
    obstacles: [
      { id: 'b1_pl1',   x: 3.8,  y: 0, width: 0.3,  height: 0.7,  blockType: 'concrete', hp: 2, supports: ['b1_shelf'] },
      { id: 'b1_pl2',   x: 4.9,  y: 0, width: 0.3,  height: 0.7,  blockType: 'wood',     hp: 2, supports: ['b1_shelf'] },
      { id: 'b1_shelf', x: 3.8,  y: 0.7, width: 1.4,  height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'divider',  x: 5.8,  y: 0, width: 0.4,  height: 1.8,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'b1_pl3',   x: 7.5,  y: 0, width: 0.3,  height: 0.7,  blockType: 'wood',     hp: 2, supports: ['b1_shelf2'] },
      { id: 'b1_pl4',   x: 8.6,  y: 0, width: 0.3,  height: 0.7,  blockType: 'concrete', hp: 2, supports: ['b1_shelf2'] },
      { id: 'b1_shelf2',x: 7.5,  y: 0.7, width: 1.4,  height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: { x: 6.5, y: 3.4, radius: 0.28 },
  ...
  //               (2) destroy concrete inner wall → ceiling collapses → king crushed
  {
    ...
    obstacles: [
      { id: 'moat1',    x: 3.0,  y: 0, width: 0.4,  height: 3.0 },
      { id: 'moat2',    x: 5.0,  y: 0, width: 0.4,  height: 2.5 },
      { id: 'fort_ol',  x: 6.5,  y: 0, width: 0.4,  height: 3.2, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort_il',  x: 7.0,  y: 0, width: 0.35, height: 2.8, blockType: 'concrete', hp: 2, supports: ['fort_roof'] },
      { id: 'fort_ir',  x: 8.2,  y: 0, width: 0.35, height: 2.8, blockType: 'concrete', hp: 2, supports: ['fort_roof'] },
      { id: 'fort_or',  x: 8.7,  y: 0, width: 0.4,  height: 3.2, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort_roof',x: 7.0,  y: 2.8, width: 1.55, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: { x: 4.0, y: 3.6, radius: 0.25 },
        bonusShots: 1,
    starThresholds: [3, 4], starMode: 'bonus',
...
multiShot: {
    ...
    targets: [
      { id: 'm1', x: 3.5, y: 0.2, radius: 0.42, pigType: 'cool', hp: 1, moving: { axis: 'x', min: 3.0, max: 4.2, speed: 1.5 } },
      { id: 'm2', x: 6.0, y: 0.2, radius: 0.42, pigType: 'cool', hp: 1, moving: { axis: 'x', min: 5.5, max: 6.8, speed: 2.0 } },
      { id: 'm3', x: 8.5, y: 0.2, radius: 0.42, pigType: 'cool', hp: 1, moving: { axis: 'x', min: 8.0, max: 9.2, speed: 1.2 } },
    ],
    obstacles: [
      { id: 'cage1l',  x: 2.8,  y: 0, width: 0.3,  height: 1.5, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'cage1r',  x: 4.3,  y: 0, width: 0.3,  height: 1.5, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'cage2l',  x: 5.3,  y: 0, width: 0.35, height: 1.5, blockType: 'concrete', hp: 2, supports: [] },
      { id: 'cage2r',  x: 6.8,  y: 0, width: 0.35, height: 1.5, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'cage3l',  x: 7.8,  y: 0, width: 0.35, height: 1.8, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'cage3rf', x: 8.3,  y: 0, width: 0.3,  height: 1.8, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'cage3rb', x: 9.3,  y: 0, width: 0.35, height: 1.8, blockType: 'stone',    hp: 3, supports: [] },
    ],
    bonusRing: null,
...
multiShot: {
    ...
    targets: [
      { id: 'stair_pig', x: 4.95, y: 1.55, radius: 0.42, pigType: 'letterman', hp: 1, moving: null, restingOn: 'stair_top' },
      { id: 'twr_pig',   x: 6.75, y: 1.9,  radius: 0.42, pigType: 'helmet',    hp: 1, moving: null, restingOn: 'twr8_4t' },
      { id: 'king',      x: 9.0,  y: 0.2,  radius: 0.55, pigType: 'king',      hp: 2, moving: null },
    ],
    obstacles: [
      { id: 'stair1',    x: 3.0,  y: 0, width: 0.5, height: 0.4, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'stair2',    x: 3.8,  y: 0, width: 0.5, height: 0.8, blockType: 'wood',     hp: 2, supports: [] },
      { id: 'stair_top', x: 4.6,  y: 0, width: 0.5, height: 1.1, blockType: 'concrete', hp: 2, supports: [] },
      { id: 'twr8_4s',   x: 6.5,  y: 0, width: 0.5, height: 0.6, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'twr8_4b',   x: 6.5,  y: 0.6, width: 0.5, height: 0.8, blockType: 'concrete', hp: 2, supports: ['twr8_4t'] },
      { id: 'twr8_4t',   x: 6.5,  y: 1.4, width: 0.5, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
      { id: 'k8_4wl',    x: 8.1,  y: 0, width: 0.35, height: 2.6, blockType: 'stone',   hp: 3, supports: [] },
      { id: 'k8_4wr',    x: 9.6,  y: 0, width: 0.35, height: 2.6, blockType: 'concrete',hp: 2, supports: ['k8_4rf'] },
      { id: 'k8_4rf',    x: 8.1,  y: 2.6, width: 1.85, height: 0.25, blockType: 'glass',  hp: 1, supports: [] },
    ],
    bonusRing: null,
...
multiShot: {
    ...
    targets: [
      { id: 'whistle',   x: 3.65, y: 1.4,  radius: 0.42, pigType: 'whistle',   hp: 1, moving: null, restingOn: 'fe_shelf' },
      { id: 'letterman', x: 6.25, y: 0.2,  radius: 0.42, pigType: 'letterman', hp: 2, moving: null },
      { id: 'king',      x: 8.5,  y: 0.2,  radius: 0.55, pigType: 'king',      hp: 2,
        moving: { axis: 'x', min: 7.8, max: 9.2, speed: 0.8 } },
    ],
    obstacles: [
      { id: 'fe_pll',   x: 3.0,  y: 0, width: 0.3,  height: 0.7,  blockType: 'wood',     hp: 2, supports: ['fe_shelf'] },
      { id: 'fe_plr',   x: 4.1,  y: 0, width: 0.3,  height: 0.7,  blockType: 'concrete', hp: 2, supports: ['fe_shelf'] },
      { id: 'fe_shelf', x: 3.0,  y: 0.7, width: 1.4,  height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'cas_wl',   x: 5.5,  y: 0, width: 0.35, height: 2.5,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'cas_wr',   x: 7.1,  y: 0, width: 0.35, height: 2.5,  blockType: 'concrete', hp: 2, supports: ['cas_roof'] },
      { id: 'cas_roof', x: 5.5,  y: 2.5, width: 1.95, height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'king_wl',  x: 7.6,  y: 0, width: 0.35, height: 3.0,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'king_wr',  x: 9.3,  y: 0, width: 0.35, height: 3.0,  blockType: 'concrete', hp: 2, supports: ['king_rf'] },
      { id: 'king_rf',  x: 7.6,  y: 3, width: 2.05, height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: { x: 4.8, y: 3.9, radius: 0.25 },
