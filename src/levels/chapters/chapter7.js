...
export const CHAPTER_7 = [
  ...
  //               (2) destroy concrete pillar → shelf falls → target falls 1.65 units
  {
    ...
    launcher: LAUNCHER,
    targets: [{ id: 'pig', x: 7.05, y: 2.7, radius: 0.45, pigType: 'helmet', hp: 1, moving: null, restingOn: 'shelf7_1' }],
    obstacles: [
      { id: 'ceil7_1',   x: 5.0,  y: 3.0,  width: 4.5,  height: 0.3 },
      { id: 'pl7_1l',    x: 6.3,  y: 0.6,  width: 0.35, height: 1.4, blockType: 'concrete', hp: 2, supports: ['shelf7_1'] },
      { id: 'pl7_1r',    x: 7.6,  y: 0.6,  width: 0.35, height: 1.4, blockType: 'concrete', hp: 2, supports: ['shelf7_1'] },
      { id: 'shelf7_1',  x: 6.3,  y: 2.0,  width: 1.7,  height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
      { id: 'guard7_1',  x: 4.5,  y: 0.6,  width: 0.4,  height: 2.4, blockType: 'stone',    hp: 3, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
  ...
  //               (2) hit concrete mid → cascade glass + target (falls 1.6 units)
  {
    ...
    obstacles: [
      ...
      { id: 'twr7_2s',  x: 7.5,  y: 0.6, width: 0.5,  height: 0.5,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'twr7_2c',  x: 7.5,  y: 1.1, width: 0.5,  height: 0.7,  blockType: 'concrete', hp: 2, supports: ['twr7_2t'] },
      { id: 'twr7_2t',  x: 7.5,  y: 1.8, width: 0.5,  height: 0.35, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
    starThresholds: [2, 3], starMode: 'moves',
  ...
  // Stone divider wall at x=5.8 separates the two zones.
  {
    ...
    launcher: LAUNCHER,
    targets: [
      { id: 't1', x: 4.55, y: 1.5,  radius: 0.40, pigType: 'helmet',    hp: 1, moving: null, restingOn: 'ch7_3sl' },
      { id: 't2', x: 7.75, y: 2.3,  radius: 0.40, pigType: 'letterman', hp: 1, moving: null, restingOn: 'ch7_3sr' },
    ],
    obstacles: [
      { id: 'ch7_3pl',  x: 4.1,  y: 0.6, width: 0.3,  height: 0.6,  blockType: 'glass',    hp: 1, supports: ['ch7_3sl'] },
      { id: 'ch7_3pr',  x: 4.9,  y: 0.6, width: 0.3,  height: 0.6,  blockType: 'glass',    hp: 1, supports: ['ch7_3sl'] },
      { id: 'ch7_3sl',  x: 4.1,  y: 1.2, width: 1.1,  height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'ch7_3div', x: 5.8,  y: 0.6, width: 0.4,  height: 2.0,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'ch7_3rb',  x: 7.5,  y: 0.6, width: 0.5,  height: 1.0,  blockType: 'concrete', hp: 2, supports: ['ch7_3sr'] },
      { id: 'ch7_3sr',  x: 7.5,  y: 1.6, width: 0.5,  height: 0.45, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
    starThresholds: [2, 3], starMode: 'moves',
  ...
  //               (2) destroy one concrete gap block → gap widens → arc can navigate through
  {
    ...
    obstacles: [
      { id: 'gap_lo',   x: 5.2,  y: 0.6, width: 0.4,  height: 0.8,  blockType: 'concrete', hp: 2, supports: [] },
      { id: 'gap_hi',   x: 5.2,  y: 1.6, width: 0.4,  height: 0.8,  blockType: 'concrete', hp: 2, supports: [] },
      { id: 'cage7_4l', x: 7.0,  y: 0.6, width: 0.35, height: 1.2,  blockType: 'glass',    hp: 1, supports: ['cage7_4t'] },
      { id: 'cage7_4r', x: 8.2,  y: 0.6, width: 0.35, height: 1.2,  blockType: 'glass',    hp: 1, supports: ['cage7_4t'] },
      { id: 'cage7_4t', x: 7.0,  y: 1.8, width: 1.55, height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
    starThresholds: [2, 3], starMode: 'moves',
  ...
  //               (2) destroy concrete wall → box opens → direct arc (if h adjusted)
  {
    ...
    obstacles: [
      { id: 'blocker7_5', x: 3.5,  y: 0.6, width: 0.4,  height: 1.5, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'box7_5l',    x: 6.3,  y: 0.6, width: 0.35, height: 2.5, blockType: 'concrete', hp: 2, supports: [] },
      { id: 'box7_5r',    x: 8.1,  y: 0.6, width: 0.35, height: 2.5, blockType: 'concrete', hp: 2, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
    starThresholds: [2, 3], starMode: 'moves',
  ...
  // Stone pillar on the right forces precise arc shape.
  {
    ...
    obstacles: [
      ...
      { id: 'pw_stone', x: 8.2,  y: 0.6, width: 0.4,  height: 2.2, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'pw_col_l', x: 6.5,  y: 0.6, width: 0.3,  height: 1.2, blockType: 'wood',     hp: 2, supports: ['pw_beam'] },
      { id: 'pw_col_r', x: 7.8,  y: 0.6, width: 0.3,  height: 1.2, blockType: 'concrete', hp: 2, supports: ['pw_beam'] },
      { id: 'pw_beam',  x: 6.5,  y: 1.8, width: 1.6,  height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
    starThresholds: [2, 3], starMode: 'moves',
  ...
  // Stone wall at x=5.8 separates the zones.
  {
    ...
    launcher: LAUNCHER,
    targets: [
      { id: 't1', x: 4.55, y: 1.6,  radius: 0.40, pigType: 'helmet',    hp: 1, moving: null, restingOn: 'sh7_7l' },
      { id: 't2', x: 7.75, y: 2.5,  radius: 0.40, pigType: 'letterman', hp: 1, moving: null, restingOn: 'sh7_7r' },
    ],
    obstacles: [
      { id: 'sh7_7ll',  x: 4.1,  y: 0.6, width: 0.3,  height: 0.65, blockType: 'concrete', hp: 2, supports: ['sh7_7l'] },
      { id: 'sh7_7lr',  x: 4.9,  y: 0.6, width: 0.3,  height: 0.65, blockType: 'concrete', hp: 2, supports: ['sh7_7l'] },
      { id: 'sh7_7l',   x: 4.1,  y: 1.25,width: 1.1,  height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'sh7_7div', x: 5.8,  y: 0.6, width: 0.4,  height: 2.0,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'sh7_7rl',  x: 7.3,  y: 0.6, width: 0.3,  height: 1.6,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'sh7_7rr',  x: 8.2,  y: 0.6, width: 0.3,  height: 1.6,  blockType: 'concrete', hp: 2, supports: ['sh7_7r'] },
      { id: 'sh7_7r',   x: 7.3,  y: 2.2, width: 1.2,  height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
    starThresholds: [2, 3], starMode: 'moves',
...
multiShot: {
    ...
    targets: [
      { id: 'guard', x: 6.5,  y: 0.8, radius: 0.42, pigType: 'letterman', hp: 1, moving: null },
      { id: 'king',  x: 7.6,  y: 0.8, radius: 0.55, pigType: 'king',      hp: 1, moving: null },
    ],
    obstacles: [
      { id: 'sw1',       x: 3.5,  y: 0.6, width: 0.4,  height: 3.5 },
      { id: 'sw2',       x: 5.8,  y: 1.2, width: 0.4,  height: 2.0 },
      { id: 'fort7_8l',  x: 6.2,  y: 0.6, width: 0.35, height: 2.0, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort7_8r',  x: 8.4,  y: 0.6, width: 0.35, height: 2.0, blockType: 'concrete', hp: 2, supports: ['fort7_8t'] },
      { id: 'fort7_8t',  x: 6.2,  y: 2.6, width: 2.55, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 3], starMode: 'moves',
    revealAfter: null,
  ...
  //               (2) destroy concrete pillar → overhang falls → crushes king
  {
    ...
    obstacles: [
      { id: 'col7_9l',  x: 5.8,  y: 0.6, width: 0.35, height: 1.7, blockType: 'concrete', hp: 2, supports: ['ovh7_9l'] },
      { id: 'ovh7_9l',  x: 5.8,  y: 2.3, width: 1.3,  height: 0.3, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'col7_9r',  x: 8.0,  y: 0.6, width: 0.35, height: 2.2, blockType: 'concrete', hp: 2, supports: ['ovh7_9r'] },
      { id: 'ovh7_9r',  x: 7.0,  y: 2.8, width: 1.35, height: 0.3, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
    starThresholds: [2, 3], starMode: 'moves',
...
multiShot: {
    ...
    targets: [{ id: 'king', x: 8.5, y: 0.8, radius: 0.55, pigType: 'king', hp: 2, moving: null }],
    obstacles: [
      { id: 'sw7_10a',  x: 3.5,  y: 0.6, width: 0.4,  height: 2.5 },
      { id: 'sw7_10b',  x: 6.0,  y: 1.5, width: 0.4,  height: 2.0 },
      { id: 'fn_wl',    x: 7.8,  y: 0.6, width: 0.35, height: 2.2, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fn_wr',    x: 9.2,  y: 0.6, width: 0.35, height: 2.2, blockType: 'concrete', hp: 2, supports: ['fn_roof'] },
