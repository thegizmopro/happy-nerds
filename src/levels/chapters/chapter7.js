...
export const CHAPTER_7 = [
  ...
  // Tower: stone base + wood + glass top. Pig on glass top.
  {
    ...
    obstacles: [
      ...
      { id: 'twr7_2b',  x: 7.5,  y: 0.6, width: 0.5, height: 0.8, blockType: 'concrete', hp: 2, supports: ['twr7_2m'] },
  ...
  // Left shelf low at x=4.5. Right shelf high at x=7.5.
  {
    ...
    obstacles: [
      ...
      { id: 'sh7_7rl', x: 7.3,  y: 0.6, width: 0.3,  height: 2.2,  blockType: 'concrete', hp: 2, supports: ['sh7_7r'] },
      { id: 'sh7_7rr', x: 8.2,  y: 0.6, width: 0.3,  height: 2.2,  blockType: 'concrete', hp: 2, supports: ['sh7_7r'] },
  ...
  // Two static walls + fortress inside. King pig (3HP) inside.
  {
    ...
    obstacles: [
      ...
      { id: 'fort7_8l', x: 6.8,  y: 0.6, width: 0.35, height: 2.0, blockType: 'concrete', hp: 2, supports: ['fort7_8t'] },
  ...
  // Two glass overhangs above pig at different heights. Inverted-V rises between them.
  {
    ...
    obstacles: [
      ...
      { id: 'col7_9l', x: 6.0, y: 0.6, width: 0.35, height: 1.7, blockType: 'concrete', hp: 2, supports: [] },
      { id: 'col7_9r', x: 8.0, y: 0.6, width: 0.35, height: 2.2, blockType: 'concrete', hp: 2, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 6], starMode: 'moves',
    revealAfter: null,
  ...
  // Grand finale: Cubic, two walls, bonus ring, king pig in elaborate fortress.
  {
    ...
    obstacles: [
      ...
      { id: 'fn_wl',    x: 7.8,  y: 0.6, width: 0.35, height: 2.2, blockType: 'concrete', hp: 2, supports: ['fn_roof'] },
