...
export const CHAPTER_4 = [
  ...
  // Kill vectors: (1) arc over stone + through glass → hits target, (2) direct high arc
  {
    ...
    launcher: LAUNCHER,
    targets: [{ id: 'pig', x: 7.8, y: 0.2, radius: 0.45, pigType: 'helmet', hp: 1, moving: null }],
    obstacles: [
      { id: 'stone_gate', x: 5.0, y: 0, width: 0.4, height: 1.8, blockType: 'stone', hp: 3, supports: [] },
      { id: 'glass_lane', x: 6.8, y: 0, width: 0.35, height: 1.6, blockType: 'glass', hp: 1, supports: [] },
    ],
    bonusRing: null,
        bonusShots: 1,
  ...
  //           Pig_3 is in the corridor between walls.
  {
    ...
    launcher: { x: 0.7, y: 0.2 },
    targets: [
      { id: 'pig_1', x: 9, y: 1.8, radius: 0.45, pigType: 'coach', hp: 1, moving: null },
      { id: 'pig_2', x: 9.3, y: 0.4, radius: 0.45, pigType: 'coach', hp: 1, moving: null },
      { id: 'pig_3', x: 6.8, y: 1.9, radius: 0.45, pigType: 'coach', hp: 1, moving: null },
    ],
    obstacles: [
      { id: 'obs_1', x: 5.8, y: 0, width: 0.5, height: 3.9, blockType: 'concrete', hp: 2, supports: [] },
      { id: 'obs_2', x: 7.5, y: 2, width: 0.5, height: 1.8, blockType: 'wood', hp: 2, supports: [] },
      { id: 'obs_3', x: 7.5, y: 0, width: 0.5, height: 2.0, blockType: 'stone', hp: 3, supports: [] },
      { id: 'obs_4', x: 9.5, y: 3.8, width: 0.5, height: 1.6, blockType: 'wood', hp: 2, supports: [] },
      { id: 'obs_5', x: 7.5, y: 3.8, width: 2.0, height: 0.5, blockType: 'wood', hp: 2, supports: [] },
      { id: 'obs_8', x: 9.5, y: 0, width: 0.5, height: 3.8, blockType: 'stone', hp: 3, supports: [] },
    ],
    bonusRing: { x: 4.7, y: 4.9, radius: 0.28 },
    bonusShots: 3,
  ...
  // Kill vectors: (1) arc through glass ceiling → target, (2) destroy concrete right wall → ceiling falls → crushes target
  {
    ...
    obstacles: [
      { id: 'stone_left',    x: 6.0, y: 0, width: 0.4,  height: 2.6, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'concrete_right',x: 8.4, y: 0, width: 0.4,  height: 2.6, blockType: 'concrete', hp: 2, supports: ['ceiling'] },
      { id: 'ceiling',       x: 6.0, y: 2.6, width: 2.8,  height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: { x: 4.5, y: 3.2, radius: 0.28 },
        bonusShots: 1,
...
multiShot: {
    ...
    targets: [
      { id: 't1', x: 5.95, y: 1.25, radius: 0.42, pigType: 'helmet', hp: 1, moving: null, restingOn: 'step2' },
      { id: 't2', x: 8.35, y: 2.05, radius: 0.42, pigType: 'letterman', hp: 1, moving: null, restingOn: 'step3' },
    ],
    obstacles: [
      { id: 'step1', x: 4.0, y: 0, width: 0.5, height: 0.5, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'step2', x: 5.7, y: 0, width: 0.5, height: 1.0, blockType: 'wood',     hp: 2, supports: [] },
      { id: 'step3', x: 8.1, y: 0, width: 0.5, height: 1.6, blockType: 'concrete', hp: 2, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 3], starMode: 'moves',
    revealAfter: null,
...
multiShot: {
    ...
    targets: [{ id: 'pig', x: 7.2, y: 0.2, radius: 0.45, pigType: 'letterman', hp: 1, moving: null }],
    obstacles: [
      { id: 'moat_wall',  x: 4.0, y: 0, width: 0.4,  height: 2.0 },
      { id: 'fort_left',  x: 6.5, y: 0, width: 0.35, height: 2.2, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort_base',  x: 6.9, y: 0, width: 0.75, height: 0.7, blockType: 'concrete', hp: 2, supports: ['fort_mid'] },
      { id: 'fort_mid',   x: 6.9, y: 0.7, width: 0.75, height: 0.6, blockType: 'wood',     hp: 2, supports: ['fort_roof'] },
      { id: 'fort_roof',  x: 6.85,y: 1.3, width: 1.2,  height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
      { id: 'fort_right', x: 8.1, y: 0, width: 0.35, height: 2.2, blockType: 'stone',    hp: 3, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 3], starMode: 'moves',
...
multiShot: {
    ...
    targets: [
      { id: 't1', x: 4.5,  y: 1.35, radius: 0.42, pigType: 'helmet',   hp: 1, moving: null, restingOn: 'shelf_l' },
      { id: 't2', x: 7.9,  y: 0.2,  radius: 0.42, pigType: 'letterman',hp: 1, moving: null },
    ],
    obstacles: [
      { id: 'pl_l',   x: 3.8,  y: 0, width: 0.35, height: 1.0, blockType: 'concrete', hp: 2, supports: ['shelf_l'] },
      { id: 'pl_r',   x: 5.0,  y: 0, width: 0.35, height: 1.0, blockType: 'wood',     hp: 2, supports: ['shelf_l'] },
      { id: 'shelf_l',x: 3.8,  y: 1, width: 1.55, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
      { id: 'cage_l', x: 7.2,  y: 0, width: 0.35, height: 1.8, blockType: 'glass',    hp: 1, supports: ['cage_top'] },
      { id: 'cage_r', x: 8.5,  y: 0, width: 0.35, height: 1.8, blockType: 'glass',    hp: 1, supports: ['cage_top'] },
      { id: 'cage_top',x: 7.2, y: 1.8, width: 1.65, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: { x: 5.8, y: 1.9, radius: 0.28 },
...
multiShot: {
    ...
    targets: [
      { id: 'pig_inside', x: 7.2,  y: 0.2,  radius: 0.45, pigType: 'letterman', hp: 1, moving: null },
      { id: 'pig_roof',   x: 7.2,  y: 3.15, radius: 0.42, pigType: 'helmet',    hp: 1, moving: null, restingOn: 'roof_shelf' },
    ],
    obstacles: [
      { id: 'wall_l',    x: 6.0,  y: 0, width: 0.4,  height: 2.6,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'wall_r',    x: 8.4,  y: 0, width: 0.4,  height: 2.6,  blockType: 'concrete', hp: 2, supports: ['ceiling'] },
      { id: 'ceiling',   x: 6.0,  y: 2.6, width: 2.8,  height: 0.25, blockType: 'glass',    hp: 1, supports: ['roof_shelf'] },
      { id: 'roof_shelf',x: 6.4,  y: 2.85, width: 1.6, height: 0.25, blockType: 'wood',     hp: 2, supports: [] },
    ],
    bonusRing: null,
...
multiShot: {
    ...
    targets: [{ id: 'king', x: 7.3, y: 0.2, radius: 0.55, pigType: 'king', hp: 2, moving: null }],
    obstacles: [
      { id: 'outer_l',  x: 5.6,  y: 0, width: 0.4,  height: 3.2, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'inner_l',  x: 6.2,  y: 0, width: 0.35, height: 2.8, blockType: 'concrete', hp: 2, supports: ['king_roof'] },
      { id: 'inner_r',  x: 8.2,  y: 0, width: 0.35, height: 2.8, blockType: 'concrete', hp: 2, supports: ['king_roof'] },
      { id: 'outer_r',  x: 8.7,  y: 0, width: 0.4,  height: 3.2, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'king_roof',x: 6.2,  y: 2.8, width: 2.35, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 3], starMode: 'moves',
    revealAfter: null,
...
multiShot: {
    ...
    targets: [
      { id: 'pyr_pig',  x: 6.8,  y: 1.65, radius: 0.42, pigType: 'helmet',    hp: 1, moving: null, restingOn: 'pyr_top' },
      { id: 'cage_pig', x: 8.6,  y: 0.2,  radius: 0.42, pigType: 'letterman', hp: 1, moving: null },
    ],
    obstacles: [
      { id: 'pyr_base', x: 5.8,  y: 0, width: 2.0,  height: 0.5,  blockType: 'concrete', hp: 2, supports: ['pyr_mid'] },
      { id: 'pyr_mid',  x: 6.15, y: 0.5, width: 1.3,  height: 0.4,  blockType: 'wood',     hp: 2, supports: ['pyr_top'] },
      { id: 'pyr_top',  x: 6.45, y: 0.9, width: 0.7,  height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'cage_l',   x: 8.0,  y: 0, width: 0.35, height: 1.8,  blockType: 'glass',    hp: 1, supports: ['cage_roof'] },
      { id: 'cage_r',   x: 9.2,  y: 0, width: 0.35, height: 1.8,  blockType: 'glass',    hp: 1, supports: ['cage_roof'] },
      { id: 'cage_roof',x: 8.0,  y: 1.8, width: 1.55, height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: { x: 4.5, y: 2.4, radius: 0.28 },
    starThresholds: [2, 3], starMode: 'bonus',
    revealAfter: null,
...
multiShot: {
    ...
    targets: [
      { id: 'twr_pig',  x: 4.55, y: 1.55, radius: 0.42, pigType: 'helmet', hp: 1, moving: null, restingOn: 'twr4_top' },
      { id: 'king',     x: 6.7,  y: 0.2,  radius: 0.55, pigType: 'king',   hp: 1, moving: null },
      { id: 'cool',     x: 8.8,  y: 0.2,  radius: 0.42, pigType: 'cool',   hp: 1,
        moving: { axis: 'x', min: 8.2, max: 9.3, speed: 1.5 } },
    ],
    obstacles: [
      { id: 'twr4_base', x: 4.2, y: 0, width: 0.5, height: 0.9,  blockType: 'concrete', hp: 2, supports: ['twr4_top'] },
      { id: 'twr4_top',  x: 4.2, y: 0.9, width: 0.5, height: 0.4,  blockType: 'wood',     hp: 2, supports: [] },
      { id: 'fort_l',    x: 6.0, y: 0, width: 0.35, height: 2.4, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort_r',    x: 7.5, y: 0, width: 0.35, height: 2.4, blockType: 'concrete', hp: 2, supports: ['fort_ceil'] },
      { id: 'fort_ceil', x: 6.0, y: 2.4, width: 1.85, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
      { id: 'glass_bar', x: 7.9, y: 0, width: 0.35, height: 1.8, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 3], starMode: 'moves',
