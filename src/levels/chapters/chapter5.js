...
export const CHAPTER_5 = [
  ...
  // Pig: x=7.2, y=0.8, letterman hp=2.
  {
    ...
    obstacles: [
      { id: 'wall_l',  x: 6.0,  y: 0.6, width: 0.35, height: 2.45, blockType: 'concrete', hp: 2, supports: ['ceiling'] },
      { id: 'wall_r',  x: 8.4,  y: 0.6, width: 0.35, height: 2.45, blockType: 'concrete', hp: 2, supports: ['ceiling'] },
  ...
  // Pig behind inner wall inside pyramid at x=7.0, y=0.8.
  {
    ...
    obstacles: [
      ...
      { id: 'inner_wall', x: 5.4, y: 0.6, width: 0.35, height: 1.5,  blockType: 'concrete', hp: 2, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [3, 8], starMode: 'moves',
    revealAfter: null,
  ...
  // King pig: x=7.6, y=0.8, hp=3.
  {
    ...
    obstacles: [
      ...
      { id: 'fort_wl',   x: 6.5,  y: 0.6, width: 0.35, height: 2.6, blockType: 'concrete', hp: 2, supports: ['fort_ceil'] },
      ...
      { id: 'fort_wr',   x: 8.7,  y: 0.6, width: 0.35, height: 2.6, blockType: 'concrete', hp: 2, supports: ['fort_ceil'] },
  ...
  // A shelf: pillars x=7.5 & 8.7, shelf y=1.3. Pig on shelf.
  {
    ...
    obstacles: [
      { id: 'b_base',  x: 3.2,  y: 0.6, width: 0.5,  height: 0.5,  blockType: 'concrete', hp: 2, supports: ['b_mid'] },
  ...
  // Two static outer walls. Fortress: stone side walls, glass roof. King inside.
  {
    ...
    obstacles: [
      ...
      { id: 'fort_l',  x: 6.8,  y: 0.6, width: 0.4,  height: 2.8, blockType: 'concrete', hp: 2, supports: ['grand_roof'] },
      { id: 'fort_r',  x: 8.6,  y: 0.6, width: 0.4,  height: 2.8, blockType: 'concrete', hp: 2, supports: ['grand_roof'] },
