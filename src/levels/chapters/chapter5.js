...
export const CHAPTER_5 = [
  ...
  // Kill vectors: (1) arc through glass ceiling → hits target, (2) break concrete wall → ceiling crushes target
  {
    ...
    launcher: LAUNCHER,
    targets: [{ id: 'pig', x: 7.3, y: 0.8, radius: 0.45, pigType: 'letterman', hp: 1, moving: null }],
    obstacles: [
      { id: 'wall_l',  x: 6.0,  y: 0.6, width: 0.4,  height: 2.65, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'wall_r',  x: 8.6,  y: 0.6, width: 0.4,  height: 2.65, blockType: 'concrete', hp: 2, supports: ['ceiling'] },
      { id: 'ceiling', x: 6.0,  y: 3.25, width: 3.0,  height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: null,
  ...
  // Kill vectors tower: (1) direct to glass top, (2) hit concrete mid → cascade → target falls
  {
    ...
    launcher: LAUNCHER,
    targets: [
      { id: 't1', x: 5.0,  y: 2.0,  radius: 0.42, pigType: 'helmet', hp: 1, moving: null, restingOn: 'shelf_a' },
      { id: 't2', x: 7.85, y: 2.75, radius: 0.42, pigType: 'helmet', hp: 1, moving: null, restingOn: 'twr_glass' },
    ],
    obstacles: [
      { id: 'shelf_pl', x: 4.2, y: 0.6, width: 0.35, height: 0.7, blockType: 'wood',     hp: 2, supports: ['shelf_a'] },
      { id: 'shelf_pr', x: 5.5, y: 0.6, width: 0.35, height: 0.7, blockType: 'wood',     hp: 2, supports: ['shelf_a'] },
      { id: 'shelf_a',  x: 4.2, y: 1.3, width: 1.65, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
      { id: 'twr_stone',x: 7.6, y: 0.6, width: 0.5,  height: 0.8, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'twr_conc', x: 7.6, y: 1.4, width: 0.5,  height: 0.6, blockType: 'concrete', hp: 2, supports: ['twr_glass'] },
      { id: 'twr_glass',x: 7.6, y: 2.0, width: 0.5,  height: 0.3, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
  ...
  //               (2) destroy concrete base → cascade → target falls 2+ units
  {
    ...
    launcher: LAUNCHER,
    targets: [{ id: 'pig', x: 7.0, y: 2.25, radius: 0.45, pigType: 'letterman', hp: 1, moving: null, restingOn: 'pyr_top' }],
    obstacles: [
      { id: 'stone_guard',x: 5.4, y: 0.6, width: 0.4,  height: 1.8, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'pyr_base',   x: 5.8, y: 0.6, width: 2.2,  height: 0.5, blockType: 'concrete', hp: 2, supports: ['pyr_mid'] },
      { id: 'pyr_mid',    x: 6.2, y: 1.1, width: 1.5,  height: 0.4, blockType: 'wood',     hp: 2, supports: ['pyr_top'] },
      { id: 'pyr_top',    x: 6.5, y: 1.5, width: 1.0,  height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [3, 8], starMode: 'moves',
    revealAfter: null,
  ...
  //               (2) direct high arc to pig on shelf
  {
    ...
    obstacles: [
      { id: 'moat',     x: 5.0, y: 0.6, width: 0.4,  height: 2.2 },
      { id: 'pillar_l', x: 6.9, y: 0.6, width: 0.35, height: 0.7, blockType: 'concrete', hp: 2, supports: ['shelf'] },
  ...
  // Kill vectors: (1) arc through glass ceiling → 2 hits king, (2) destroy concrete right → ceiling drops
  {
    ...
    obstacles: [
      { id: 'moat_1',    x: 3.5, y: 0.6, width: 0.4,  height: 2.8 },
      { id: 'moat_2',    x: 5.5, y: 0.6, width: 0.4,  height: 2.4 },
      { id: 'fort_l',    x: 6.5, y: 0.6, width: 0.4,  height: 2.8, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'fort_r',    x: 8.7, y: 0.6, width: 0.4,  height: 2.8, blockType: 'concrete', hp: 2, supports: ['fort_roof'] },
      { id: 'fort_roof', x: 6.5, y: 3.4, width: 2.6,  height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [3, 8], starMode: 'moves',
    revealAfter: null,
  ...
  //               (2) destroy concrete pillar → both ceiling layers fall → crush pig
  {
    ...
    obstacles: [
      { id: 'pillar_l',  x: 6.0, y: 0.6, width: 0.35, height: 2.0, blockType: 'concrete', hp: 2, supports: ['slab_wood'] },
      { id: 'pillar_r',  x: 8.4, y: 0.6, width: 0.35, height: 2.0, blockType: 'concrete', hp: 2, supports: ['slab_wood'] },
  ...
  // Kill vectors: (1) direct arc at moving pig, (2) tower collapse hits pig if in range
  {
    ...
    obstacles: [
      { id: 'tl_base',  x: 4.2, y: 0.6, width: 0.5, height: 0.8, blockType: 'concrete', hp: 2, supports: ['tl_top'] },
      { id: 'tl_top',   x: 4.2, y: 1.4, width: 0.5, height: 0.4, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'tr_stone', x: 8.2, y: 0.6, width: 0.5, height: 0.8, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'tr_glass', x: 8.2, y: 1.4, width: 0.5, height: 0.4, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
  ...
  // Structure 3 (right x≈8): wood shelf pig.
  {
    ...
    targets: [
      { id: 't1', x: 3.45, y: 2.05, radius: 0.40, pigType: 'helmet',    hp: 1, moving: null, restingOn: 'left_top' },
      { id: 't2', x: 6.1,  y: 0.8,  radius: 0.40, pigType: 'letterman', hp: 1, moving: null },
      { id: 't3', x: 8.35, y: 2.0,  radius: 0.40, pigType: 'helmet',    hp: 1, moving: null, restingOn: 'right_shelf' },
    ],
    obstacles: [
      { id: 'left_base', x: 3.1, y: 0.6, width: 0.5, height: 0.8,  blockType: 'concrete', hp: 2, supports: ['left_top'] },
      { id: 'left_top',  x: 3.1, y: 1.4, width: 0.5, height: 0.4,  blockType: 'glass',    hp: 1, supports: [] },
      { id: 'mid_wall',  x: 5.5, y: 0.6, width: 0.4, height: 2.0 },
      { id: 'mid_conc',  x: 6.5, y: 0.6, width: 0.4, height: 2.0,  blockType: 'concrete', hp: 2, supports: [] },
      { id: 'right_pl',  x: 7.7, y: 0.6, width: 0.35, height: 0.7, blockType: 'wood',     hp: 2, supports: ['right_shelf'] },
      { id: 'right_pr',  x: 8.9, y: 0.6, width: 0.35, height: 0.7, blockType: 'wood',     hp: 2, supports: ['right_shelf'] },
      { id: 'right_shelf',x:7.7, y: 1.3, width: 1.55, height: 0.25, blockType: 'glass',   hp: 1, supports: [] },
    ],
    bonusRing: null,
  ...
  // Kill vectors bottom: (1) destroy wood floor → falls through to ground, (2) arc through exposed cell
  {
    ...
    targets: [
      { id: 'top_pig', x: 7.15, y: 2.9, radius: 0.42, pigType: 'helmet', hp: 1, moving: null, restingOn: 'mid_shelf' },
      { id: 'bot_pig', x: 7.15, y: 0.8, radius: 0.42, pigType: 'letterman', hp: 1, moving: null },
    ],
    obstacles: [
      { id: 'cage_l',   x: 6.5,  y: 0.6, width: 0.35, height: 3.2,  blockType: 'concrete', hp: 2, supports: ['top_roof'] },
      { id: 'cage_r',   x: 7.95, y: 0.6, width: 0.35, height: 3.2,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'mid_shelf',x: 6.85, y: 2.2, width: 1.1,  height: 0.25, blockType: 'wood',     hp: 2, supports: [] },
      { id: 'top_roof', x: 6.85, y: 3.6, width: 1.1,  height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [3, 8], starMode: 'moves',
  ...
  // Full structural complexity: shelf + enclosed castle + stone fortress + bonus ring.
  {
    ...
    targets: [
      ...
      { id: 'letterman',x: 6.2,  y: 0.8,  radius: 0.42, pigType: 'letterman', hp: 2, moving: null },
      { id: 'king',     x: 8.7,  y: 0.8,  radius: 0.55, pigType: 'king',      hp: 1, moving: null },
    ],
    obstacles: [
      { id: 'ws_pll',   x: 3.0,  y: 0.6, width: 0.3,  height: 0.7,  blockType: 'wood',     hp: 2, supports: ['ws_shelf'] },
      { id: 'ws_plr',   x: 4.1,  y: 0.6, width: 0.3,  height: 0.7,  blockType: 'wood',     hp: 2, supports: ['ws_shelf'] },
      ...
      { id: 'cas_wr',   x: 7.0,  y: 0.6, width: 0.35, height: 2.5,  blockType: 'concrete', hp: 2, supports: ['cas_roof'] },
      { id: 'cas_roof', x: 5.5,  y: 3.1, width: 1.85, height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
      { id: 'king_wl',  x: 8.0,  y: 0.6, width: 0.35, height: 2.8,  blockType: 'stone',    hp: 3, supports: [] },
      { id: 'king_wr',  x: 9.3,  y: 0.6, width: 0.35, height: 2.8,  blockType: 'concrete', hp: 2, supports: ['king_rf'] },
      { id: 'king_rf',  x: 8.0,  y: 3.4, width: 1.65, height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
    ],
