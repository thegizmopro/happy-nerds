...
export const CHAPTER_3 = [
  ...
  // Pig at (8.4, 0.8): h=3.7 for any a. Wide (shallow) arc clears short wall.
  {
    ...
    obstacles: [
      ...
      { id: 'stone_col_l', x: 7.5,  y: 0.8, width: 0.35, height: 1.2, blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 9.0,  y: 0.8, width: 0.35, height: 1.2, blockType: 'stone', hp: 3, supports: ["stone_beam"] },
  ...
  // Solution: a≈-0.243, h≈3.5.
  {
    ...
    obstacles: [
      { id: 'stone_col_l', x: 5.8,  y: 0.8,  width: 0.3, height: 0.7,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 6.8,  y: 0.8,  width: 0.3, height: 0.7,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_beam',  x: 5.8,  y: 1.5,  width: 1.3, height: 0.2,  blockType: 'stone', hp: 3, supports: ["wood_col_l","wood_col_r"] },
  ...
  // Solution: a≈-0.267, h≈4.0 clears all three and hits pig.
  {
    ...
    obstacles: [
      ...
      { id: 'stone_col_l', x: 8.0,  y: 0.8, width: 0.35, height: 1.25, blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 9.2,  y: 0.8, width: 0.35, height: 1.25, blockType: 'stone', hp: 3, supports: ["stone_beam"] },
  ...
  // Bonus ring + king pig: a≈-0.212, h≈4.0.
  {
    ...
    obstacles: [
      ...
      { id: 'stone_col_l', x: 6.3,  y: 0.8,  width: 0.35, height: 0.8,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 8.0,  y: 0.8,  width: 0.35, height: 0.8,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_beam',  x: 6.3,  y: 1.6,  width: 2.05, height: 0.2,  blockType: 'stone', hp: 3, supports: ["wood_col_l","wood_col_r"] },
