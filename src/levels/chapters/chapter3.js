...
export const CHAPTER_3 = [
  ...
  // Player must discover positive a to reach the ring.
  {
    ...
    obstacles: [
      { id: 'wood_col_l', x: 4.7,  y: 0.8, width: 0.35, height: 1.2,  blockType: 'wood',  hp: 2, supports: [] },
      { id: 'wood_col_r', x: 6.45, y: 0.8, width: 0.35, height: 1.2,  blockType: 'wood',  hp: 2, supports: [] },
  ...
  // Solution: a≈-0.167, h≈3.5. Arc enters channel between floor and ceiling.
  {
    ...
    obstacles: [
      ...
      { id: 'wood_col_l', x: 5.8,  y: 1.1,  width: 0.3,  height: 0.5,  blockType: 'wood',  hp: 2, supports: [] },
      { id: 'wood_col_r', x: 7.2,  y: 1.1,  width: 0.3,  height: 0.5,  blockType: 'wood',  hp: 2, supports: [] },
  ...
  // Pig at (8.4, 0.8): h=3.7 for any a. Wide (shallow) arc clears short wall.
  {
    ...
    obstacles: [
      ...
      { id: 'stone_col_l', x: 7.5,  y: 0.8, width: 0.35, height: 1.2, blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_col_r', x: 9.0,  y: 0.8, width: 0.35, height: 1.2, blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_beam',  x: 7.5,  y: 2.0, width: 1.85, height: 0.2, blockType: 'stone', hp: 3, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 5], starMode: 'moves',
    revealAfter: null,
  ...
  // Solution: a≈-0.243, h≈3.5.
  {
    ...
    defaultParams: { a: -0.25, h: 3.5, k: 3.1 },
    launcher: LAUNCHER,
    ...
    obstacles: [
      ...
      { id: 'stone_beam',  x: 5.8,  y: 1.5,  width: 1.3, height: 0.2,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'wood_col_l',  x: 5.8,  y: 1.7,  width: 0.3, height: 0.55, blockType: 'wood',  hp: 2, supports: [] },
      { id: 'wood_col_r',  x: 6.8,  y: 1.7,  width: 0.3, height: 0.55, blockType: 'wood',  hp: 2, supports: [] },
  ...
  // Solution: a≈-0.267, h≈4.0 clears all three and hits pig.
  {
    ...
    obstacles: [
      ...
      { id: 'stone_col_l', x: 8.0,  y: 0.8, width: 0.35, height: 1.25, blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_col_r', x: 9.2,  y: 0.8, width: 0.35, height: 1.25, blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_beam',  x: 8.0,  y: 2.05, width: 1.55, height: 0.2, blockType: 'stone', hp: 3, supports: [] },
    ],
  ...
  // One-arc solution: a≈-0.104, h≈3.55 hits t1 at y=2.0 and t2 at y=0.8.
  {
    ...
    obstacles: [
      ...
      { id: 'g_col_r',  x: 6.2,  y: 0.8, width: 0.3,  height: 1.45, blockType: 'glass', hp: 1, supports: [] },
      { id: 'g_beam',   x: 4.9,  y: 2.25, width: 1.6,  height: 0.2,  blockType: 'glass', hp: 1, supports: [] },
      { id: 'w_col_l',  x: 7.4,  y: 0.8, width: 0.35, height: 0.8,  blockType: 'wood',  hp: 2, supports: [] },
      { id: 'w_col_r',  x: 8.7,  y: 0.8, width: 0.35, height: 0.8,  blockType: 'wood',  hp: 2, supports: [] },
  ...
  // Hit whistle pig first (left arch); then helmet pig (right arch).
  {
    ...
    obstacles: [
      ...
      { id: 'g_col_r',  x: 7.0,  y: 0.8, width: 0.3,  height: 1.0,  blockType: 'glass', hp: 1, supports: [] },
      { id: 'g_beam',   x: 5.8,  y: 1.8, width: 1.5,  height: 0.2,  blockType: 'glass', hp: 1, supports: [] },
      { id: 'w_col_l',  x: 7.8,  y: 0.8, width: 0.3,  height: 0.8,  blockType: 'wood',  hp: 2, supports: [] },
      { id: 'w_col_r',  x: 9.0,  y: 0.8, width: 0.3,  height: 0.8,  blockType: 'wood',  hp: 2, supports: [] },
  ...
  // Set h, find a that clears wall AND reaches pig height, then time the shot.
  {
    ...
    defaultParams: { a: -0.18, h: 4.0, k: 2.9 },
    launcher: LAUNCHER,
    targets: [{
    ...
    obstacles: [
      ...
      { id: 'gate_col_l', x: 6.2,  y: 0.8, width: 0.3,  height: 1.8, blockType: 'wood', hp: 2, supports: [] },
      { id: 'gate_col_r', x: 8.2,  y: 0.8, width: 0.3,  height: 1.8, blockType: 'wood', hp: 2, supports: [] },
  ...
  // Bonus ring + king pig: a≈-0.212, h≈4.0.
  {
    ...
    defaultParams: { a: -0.14, h: 4.5, k: 2.8 },
    launcher: LAUNCHER,
    ...
    obstacles: [
      ...
      { id: 'stone_col_r', x: 8.0,  y: 0.8,  width: 0.35, height: 0.8,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_beam',  x: 6.3,  y: 1.6,  width: 2.05, height: 0.2,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'wood_col_l',  x: 6.3,  y: 1.8,  width: 0.35, height: 0.5,  blockType: 'wood',  hp: 2, supports: [] },
      { id: 'wood_col_r',  x: 8.0,  y: 1.8,  width: 0.35, height: 0.5,  blockType: 'wood',  hp: 2, supports: [] },
