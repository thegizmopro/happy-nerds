...
export const CHAPTER_3 = [
  ...
  // Kill vectors: (1) through glass ceiling → direct, (2) break concrete wall → ceiling collapses → crush
  {
    ...
    launcher: LAUNCHER,
    targets: [{ id: 'pig', x: 7.0, y: 0.8, radius: 0.42, pigType: 'helmet', hp: 1, moving: null }],
    obstacles: [
      { id: 'stone_left',     x: 5.8, y: 0.8, width: 0.4, height: 2.4, blockType: 'stone',    hp: 3, supports: [] },
      { id: 'concrete_right', x: 8.0, y: 0.8, width: 0.4, height: 2.4, blockType: 'concrete', hp: 2, supports: ['ceiling'] },
      { id: 'ceiling',        x: 5.8, y: 3.2, width: 2.6, height: 0.25, blockType: 'glass',    hp: 1, supports: [] },
    ],
    bonusRing: null,
  ...
  // Arc must clear stone wall (indestructible) and pass through glass.
  {
    ...
    obstacles: [
      { id: 'stone_wall',  x: 3.5, y: 0.8, width: 0.4, height: 1.5, blockType: 'stone', hp: 3, supports: [] },
      { id: 'glass_lane', x: 5.5, y: 0.8, width: 0.35, height: 1.2, blockType: 'glass', hp: 1, supports: [] },
      { id: 'concrete_pillar', x: 7.5, y: 0.8, width: 0.35, height: 1.2, blockType: 'concrete', hp: 2, supports: ['concrete_beam'] },
      { id: 'concrete_beam', x: 7.5, y: 2.0, width: 1.85, height: 0.2, blockType: 'concrete', hp: 2, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 5], starMode: 'moves',
    revealAfter: null,
  ...
  // Kill vectors: (1) arc through glass beam → first pig falls, (2) arc hits second pig directly
  {
    ...
    launcher: LAUNCHER,
    targets: [
      { id: 't1', x: 5.6, y: 2.0, radius: 0.42, pigType: 'helmet', hp: 1, moving: null, restingOn: 'g_beam' },
      { id: 't2', x: 8.1, y: 0.8, radius: 0.42, pigType: 'letterman', hp: 1, moving: null },
    ],
    obstacles: [
      ...
      { id: 'w_col_l',  x: 7.4, y: 0.8, width: 0.35, height: 0.8, blockType: 'concrete', hp: 2, supports: ['w_beam'] },
      { id: 'w_col_r',  x: 8.7, y: 0.8, width: 0.35, height: 0.8, blockType: 'concrete', hp: 2, supports: ['w_beam'] },
      { id: 'w_beam',   x: 7.4, y: 1.6, width: 1.65, height: 0.2, blockType: 'concrete', hp: 2, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 5], starMode: 'moves',
    revealAfter: null,
  ...
  // Glass arch + glass floor = satisfying shatter cascade.
  {
    ...
    launcher: LAUNCHER,
    targets: [{ id: 'whistle', x: 6.5, y: 0.8, radius: 0.45, pigType: 'whistle', hp: 1, moving: null }],
    obstacles: [
