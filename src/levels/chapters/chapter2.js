...
export const CHAPTER_2 = [
  ...
  // Pig inside arch at ground level. Solution: k=0, h≈5.65 (vertex at pig x).
  {
    ...
    obstacles: [
      { id: 'glass_col_l', x: 5.8, y: 0.8, width: 0.3,  height: 1.2, blockType: 'glass', hp: 1, supports: [] },
      { id: 'glass_col_r', x: 7.2, y: 0.8, width: 0.3,  height: 1.2, blockType: 'glass', hp: 1, supports: [] },
  ...
  // Strategy B: direct hit at (6.075, 3.0) with k≈2.2.
  {
    ...
    obstacles: [
      ...
      { id: 'glass_col_l', x: 5.2,  y: 1.8, width: 0.35, height: 0.5,  blockType: 'glass', hp: 1, supports: [] },
      { id: 'glass_col_r', x: 6.95, y: 1.8, width: 0.35, height: 0.5,  blockType: 'glass', hp: 1, supports: [] },
  ...
  // Bonus ring at (4.5, 3.8): solution a≈-0.20, h≈3.5, k≈3.0.
  {
    ...
    obstacles: [
      { id: 'stone_col_l', x: 5.6,  y: 0.8,  width: 0.3,  height: 0.8,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_col_r', x: 6.8,  y: 0.8,  width: 0.3,  height: 0.8,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_beam',  x: 5.6,  y: 1.6,  width: 1.5,  height: 0.2,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'glass_col_l', x: 5.6,  y: 1.8,  width: 0.3,  height: 0.65, blockType: 'glass', hp: 1, supports: [] },
      { id: 'glass_col_r', x: 6.8,  y: 1.8,  width: 0.3,  height: 0.65, blockType: 'glass', hp: 1, supports: [] },
  ...
  // Stone is 3HP — easier to arc THROUGH than to break. Solution: k=0, h≈5.8.
  {
    ...
    obstacles: [
      { id: 'stone_col_l', x: 5.0,  y: 0.8, width: 0.35, height: 1.6,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_col_r', x: 7.5,  y: 0.8, width: 0.35, height: 1.6,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_beam',  x: 5.0,  y: 2.4, width: 2.85, height: 0.25, blockType: 'stone', hp: 3, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 6], starMode: 'moves',
    revealAfter: null,
  ...
  // Recalc: glass_col starts at 2.45, height 0.4 → top 2.85; glass_beam y=2.85 h=0.2 → top 3.05; pig y=3.5.
  {
    ...
    obstacles: [
      ...
      { id: 'stone_beam',  x: 5.9,  y: 1.5,  width: 1.3, height: 0.2,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'wood_col_l',  x: 5.9,  y: 1.7,  width: 0.3, height: 0.55, blockType: 'wood',  hp: 2, supports: [] },
      { id: 'wood_col_r',  x: 6.9,  y: 1.7,  width: 0.3, height: 0.55, blockType: 'wood',  hp: 2, supports: [] },
      { id: 'wood_beam',   x: 5.9,  y: 2.25, width: 1.3, height: 0.2,  blockType: 'wood',  hp: 2, supports: [] },
      { id: 'glass_col_l', x: 5.9,  y: 2.45, width: 0.3, height: 0.4,  blockType: 'glass', hp: 1, supports: [] },
      { id: 'glass_col_r', x: 6.9,  y: 2.45, width: 0.3, height: 0.4,  blockType: 'glass', hp: 1, supports: [] },
  ...
  // Pig inside arch at (8.0, 1.2). Solution: a≈-0.14, h≈4.1, k≈2.0.
  {
    ...
    obstacles: [
      { id: 'glass_col_l', x: 7.1,  y: 0.8, width: 0.3,  height: 0.9, blockType: 'glass', hp: 1, supports: [] },
      { id: 'glass_col_r', x: 8.6,  y: 0.8, width: 0.3,  height: 0.9, blockType: 'glass', hp: 1, supports: [] },
  ...
  // then descend inside the arch opening. Solution: a≈-0.40, h≈3.0, k≈3.14.
  {
    ...
    obstacles: [
      ...
      { id: 'stone_col_l', x: 5.8,  y: 0.8, width: 0.35, height: 1.5, blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_col_r', x: 7.5,  y: 0.8, width: 0.35, height: 1.5, blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_beam',  x: 5.8,  y: 2.3, width: 2.05, height: 0.25, blockType: 'stone', hp: 3, supports: [] },
    ],
    bonusRing: null,
    starThresholds: [2, 6], starMode: 'moves',
    revealAfter: null,
  ...
  // Solution: arc stays between y=2.6 and y=3.5 at x=3.5–8.0, then descends to pig.
  {
    ...
    obstacles: [
      ...
      { id: 'wood_col_l', x: 7.8, y: 0.8,  width: 0.3,  height: 0.8, blockType: 'wood',  hp: 2, supports: [] },
      { id: 'wood_col_r', x: 8.8, y: 0.8,  width: 0.3,  height: 0.8, blockType: 'wood',  hp: 2, supports: [] },
  ...
  // Bonus ring + pig: two constraints. Solution: a≈-0.151, h≈4.0, k≈2.55.
  {
    ...
    obstacles: [
      { id: 'stone_col_l', x: 7.7,  y: 0.8, width: 0.3,  height: 0.8,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_col_r', x: 9.0,  y: 0.8, width: 0.3,  height: 0.8,  blockType: 'stone', hp: 3, supports: [] },
      { id: 'stone_beam',  x: 7.7,  y: 1.6, width: 1.6,  height: 0.2,  blockType: 'stone', hp: 3, supports: [] },
  ...
  // No restingOn: pig is moving. Arc clears wall, threads gate, times the shot.
  {
    ...
    obstacles: [
      ...
      { id: 'gate_col_l',  x: 5.8,  y: 0.8, width: 0.3,  height: 2.0, blockType: 'wood', hp: 2, supports: [] },
      { id: 'gate_col_r',  x: 7.7,  y: 0.8, width: 0.3,  height: 2.0, blockType: 'wood', hp: 2, supports: [] },
