...
export const CHAPTER_2 = [
  ...
  // Bonus ring at (4.5, 3.8): solution a≈-0.20, h≈3.5, k≈3.0.
  {
    ...
    obstacles: [
      { id: 'stone_col_l', x: 5.6,  y: 0.8,  width: 0.3,  height: 0.8,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 6.8,  y: 0.8,  width: 0.3,  height: 0.8,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_beam',  x: 5.6,  y: 1.6,  width: 1.5,  height: 0.2,  blockType: 'stone', hp: 3, supports: ["glass_col_l","glass_col_r"] },
  ...
  // Stone is 3HP — easier to arc THROUGH than to break. Solution: k=0, h≈5.8.
  {
    ...
    obstacles: [
      { id: 'stone_col_l', x: 5.0,  y: 0.8, width: 0.35, height: 1.6,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 7.5,  y: 0.8, width: 0.35, height: 1.6,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
  ...
  // Recalc: glass_col starts at 2.45, height 0.4 → top 2.85; glass_beam y=2.85 h=0.2 → top 3.05; pig y=3.5.
  {
    ...
    obstacles: [
      { id: 'stone_col_l', x: 5.9,  y: 0.8,  width: 0.3, height: 0.7,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 6.9,  y: 0.8,  width: 0.3, height: 0.7,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_beam',  x: 5.9,  y: 1.5,  width: 1.3, height: 0.2,  blockType: 'stone', hp: 3, supports: ["wood_col_l","wood_col_r"] },
  ...
  // then descend inside the arch opening. Solution: a≈-0.40, h≈3.0, k≈3.14.
  {
    ...
    obstacles: [
      ...
      { id: 'stone_col_l', x: 5.8,  y: 0.8, width: 0.35, height: 1.5, blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 7.5,  y: 0.8, width: 0.35, height: 1.5, blockType: 'stone', hp: 3, supports: ["stone_beam"] },
  ...
  // Bonus ring + pig: two constraints. Solution: a≈-0.151, h≈4.0, k≈2.55.
  {
    ...
    obstacles: [
      { id: 'stone_col_l', x: 7.7,  y: 0.8, width: 0.3,  height: 0.8,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
      { id: 'stone_col_r', x: 9.0,  y: 0.8, width: 0.3,  height: 0.8,  blockType: 'stone', hp: 3, supports: ["stone_beam"] },
