...
export const CHAPTER_6 = [
  ...
  // Pig inside at x=7.25.
  {
    ...
    obstacles: [
      { id: 'st_wl',   x: 6.0,  y: 0.6, width: 0.35, height: 2.65, blockType: 'stone', hp: 3, supports: ['castle_roof'] },
      ...
      { id: 'st_wr',   x: 8.5,  y: 0.6, width: 0.35, height: 2.65, blockType: 'stone', hp: 3, supports: ['castle_roof'] },
  ...
  // Tower 1 (near, glass only): x=3.5. Tower 2 (mid, wood+glass): x=6.0. Tower 3 (far, stone+wood+glass): x=8.5.
  {
    ...
    multiShot: {
      ...
      sequenceMode: 'sequential',
      shots: [
        shot('Shot 1 — Glass tower',  { a: -0.35, h: 1.5 }),
        shot('Shot 2 — Wood tower',   { a: -0.18, h: 3.5 }),
        shot('Shot 3 — Stone tower',  { a: -0.07, h: 6.0 }),
      ],
    },
    targets: [
    ...
    obstacles: [
      ...
      { id: 'twr3_base', x: 8.5,  y: 0.6, width: 0.5, height: 0.8,  blockType: 'stone', hp: 3, supports: ['twr3_mid'] },
  ...
  // Left wing: glass shelf with letterman. Right wing: wood tower with letterman. King in stone core center.
  {
    ...
    multiShot: {
      ...
      sequenceMode: 'sequential',
      shots: [
        shot('Shot 1 — Left shelf pillar', { a: -0.22, h: 2.0 }),
        shot('Shot 2 — Right tower',       { a: -0.10, h: 5.5 }),
        shot('Shot 3 — Right tower',       { a: -0.09, h: 5.5 }),
        shot('Shot 4 — King (glass roof)', { a: -0.12, h: 4.5 }),
        shot('Shot 5 — King finish',       { a: -0.11, h: 4.5 }),
      ],
    },
    targets: [
    ...
    obstacles: [
      ...
      { id: 'king_wl',     x: 5.5,  y: 0.6, width: 0.35, height: 2.5,  blockType: 'stone', hp: 3, supports: ['king_roof'] },
      { id: 'king_wr',     x: 6.8,  y: 0.6, width: 0.35, height: 2.5,  blockType: 'stone', hp: 3, supports: ['king_roof'] },
      { id: 'king_roof',   x: 5.5,  y: 3.1, width: 1.65, height: 0.25, blockType: 'glass', hp: 1, supports: [] },
      { id: 'right_base',  x: 8.0,  y: 0.6, width: 0.5,  height: 0.8,  blockType: 'stone', hp: 3, supports: ['right_mid'] },
  ...
  // Guard pig on tower at x=4.0 (glass + wood). King in stone fortress at x=7.5.
  {
    ...
    multiShot: {
      ...
      sequenceMode: 'sequential',
      shots: [
        shot('Shot 1 — Guard tower', { a: -0.30, h: 1.8 }),
        shot('Shot 2 — Guard tower', { a: -0.28, h: 2.0 }),
        shot('Shot 3 — Fortress roof', { a: -0.10, h: 4.5 }),
        shot('Shot 4 — King hit',      { a: -0.09, h: 5.0 }),
        shot('Shot 5 — King finish',   { a: -0.09, h: 5.0 }),
      ],
    },
    targets: [
    ...
    obstacles: [
      ...
      { id: 'fort_wl',    x: 6.8,  y: 0.6, width: 0.35, height: 2.4,  blockType: 'stone', hp: 3, supports: ['fort_roof'] },
      { id: 'fort_wr',    x: 8.2,  y: 0.6, width: 0.35, height: 2.4,  blockType: 'stone', hp: 3, supports: ['fort_roof'] },
  ...
  // Left shelf: x=3.5. Right shelf: x=7.0. Bonus ring at x=5.5.
  {
    ...
    multiShot: {
      ...
      sequenceMode: 'sequential',
      shots: [
        shot('Shot 1 — Left shelf', { a: -0.20, h: 2.0 }),
        shot('Shot 2 — Right shelf', { a: -0.10, h: 5.5 }),
      ],
    },
    targets: [
  ...
  // 3 targets at ascending heights, each on their own shelf. 5 shots total.
  {
    ...
    multiShot: {
      ...
      shots: [
        ...
        shot('Shot 2 — Low shelf',  { a: -0.25, h: 2.0 }),
    ...
    obstacles: [
      ...
      { id: 'sh3_pl', x: 8.2,  y: 0.6, width: 0.3,  height: 2.2,  blockType: 'stone', hp: 3, supports: ['sh3'] },
      { id: 'sh3_pr', x: 9.1,  y: 0.6, width: 0.3,  height: 2.2,  blockType: 'stone', hp: 3, supports: ['sh3'] },
  ...
  // 6 shots. Whistle → letterman → king. All archetypes combined.
  {
    ...
    multiShot: {
      ...
      sequenceMode: 'sequential',
      shots: [
        shot('Shot 1 — Whistle shelf',    { a: -0.30, h: 1.8 }),
        shot('Shot 2 — Castle roof',      { a: -0.16, h: 4.0 }),
        shot('Shot 3 — Letterman hit 1',  { a: -0.14, h: 4.2 }),
        shot('Shot 4 — King fortress',    { a: -0.10, h: 5.5 }),
        shot('Shot 5 — King hit 2',       { a: -0.09, h: 5.5 }),
        shot('Shot 6 — King finish',      { a: -0.08, h: 5.5 }),
      ],
    },
    targets: [
    ...
    obstacles: [
      ...
      { id: 'cas_wl',   x: 5.3,  y: 0.6, width: 0.35, height: 2.4,  blockType: 'stone', hp: 3, supports: ['cas_roof'] },
      { id: 'cas_wr',   x: 6.9,  y: 0.6, width: 0.35, height: 2.4,  blockType: 'stone', hp: 3, supports: ['cas_roof'] },
      { id: 'cas_roof', x: 5.3,  y: 3.0, width: 2.0,  height: 0.25, blockType: 'glass', hp: 1, supports: [] },
      { id: 'king_wl',  x: 7.8,  y: 0.6, width: 0.35, height: 2.8,  blockType: 'stone', hp: 3, supports: ['king_roof'] },
      { id: 'king_wr',  x: 9.3,  y: 0.6, width: 0.35, height: 2.8,  blockType: 'stone', hp: 3, supports: ['king_roof'] },
